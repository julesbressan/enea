...
drivers_df = drivers_df[["ACCIDENT_NO","VEHICLE_ID","Age Group","SEX","PERSON_ID"]]
drivers_df = drivers_df.rename(columns={"Age Group": "Driver Age Group", "SEX" :"Driver sex",})
drivers_df = drivers_df.set_index(["ACCIDENT_NO","VEHICLE_ID","PERSON_ID" ])

#%%
#Let's select some features 
df = df[["ACCIDENT_NO","PERSON_ID","VEHICLE_ID","SEX","Age Group","INJ_LEVEL","SEATING_POSITION", "Road User Type Desc"]]
